...
public final class ItemRiwayatPendakianUserBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final CardView cvRiwayatPendakianUser;
  ...
  private ItemRiwayatPendakianUserBinding(@NonNull CardView rootView, @NonNull LinearLayout btnEdit,
      @NonNull CardView cvRiwayatPendakianUser, @NonNull ImageView imgDoubleArrow,
      @NonNull TextView tvNaik, @NonNull TextView tvNaikPos1, @NonNull TextView tvNaikPos2,
      @NonNull TextView tvNaikPos3, @NonNull TextView tvNamaPendaki, @NonNull TextView tvNamaRegu,
      @NonNull TextView tvStatusPendakian, @NonNull TextView tvTurun, @NonNull TextView tvTurunPos1,
      @NonNull TextView tvTurunPos2, @NonNull TextView tvTurunPos3, @NonNull TextView tvWaktuMulai,
      @NonNull TextView tvWaktuSelesai) {
    this.rootView = rootView;
    this.btnEdit = btnEdit;
    this.cvRiwayatPendakianUser = cvRiwayatPendakianUser;
  ...
  @NonNull
  public static ItemRiwayatPendakianUserBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemRiwayatPendakianUserBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_riwayat_pendakian_user, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemRiwayatPendakianUserBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      CardView cvRiwayatPendakianUser = (CardView) rootView;
      ...
      return new ItemRiwayatPendakianUserBinding((CardView) rootView, btnEdit,
          cvRiwayatPendakianUser, imgDoubleArrow, tvNaik, tvNaikPos1, tvNaikPos2, tvNaikPos3,
