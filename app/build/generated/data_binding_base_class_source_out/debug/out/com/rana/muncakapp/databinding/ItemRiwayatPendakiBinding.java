...
public final class ItemRiwayatPendakiBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final CardView cvRiwayatPendaki;
  ...
  private ItemRiwayatPendakiBinding(@NonNull CardView rootView, @NonNull LinearLayout btnEdit,
      @NonNull LinearLayout btnHapus, @NonNull CardView cvRiwayatPendaki,
    ...
    this.cvRiwayatPendaki = cvRiwayatPendaki;
  ...
  @NonNull
  public static ItemRiwayatPendakiBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemRiwayatPendakiBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_riwayat_pendaki, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemRiwayatPendakiBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      CardView cvRiwayatPendaki = (CardView) rootView;
      ...
      return new ItemRiwayatPendakiBinding((CardView) rootView, btnEdit, btnHapus, cvRiwayatPendaki,
