...
class KelolaRiwayatPendakianUser : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_kelola_riwayat_pendakian_user)
                ...
                .getAsJSONObject(object : JSONObjectRequestListener {
                    override fun onResponse(response: JSONObject?) {
                        ...
                        if(response?.getString("message")=="Data Riwayat Pendakian Berhasil di Tambahkan"){
                            ...
                            startActivity(Intent(this@KelolaRiwayatPendakianUser, RencanaPendakian::class.java))
                            finish()
                        }else {
                            Toast.makeText(applicationContext,response?.getString("message"), Toast.LENGTH_SHORT).show()
                        }
