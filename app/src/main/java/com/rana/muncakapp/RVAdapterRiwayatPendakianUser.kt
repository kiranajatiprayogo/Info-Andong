...
class RVAdapterRiwayatPendakianUser (private val context: Context, private var arrayList: ArrayList<RiwayatPerjalanan>)
    : RecyclerView.Adapter<RVAdapterRiwayatPendakianUser.Holder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        return Holder(LayoutInflater.from(parent.context).inflate(R.layout.item_riwayat_pendakian_user, parent, false))
    }
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.btn_edit.setOnClickListener {
            val i = Intent(context, KelolaRiwayatPendakianUser::class.java)
