...
class RVAdapterRiwayatPendaki (private val context: Context, private val arrayList: ArrayList<Pendaki>)
    : RecyclerView.Adapter<RVAdapterRiwayatPendaki.Holder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        return Holder(LayoutInflater.from(parent.context).inflate(R.layout.item_riwayat_pendaki, parent, false))
    }
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.btn_edit.setOnClickListener {
            val i = Intent(context, KelolaRiwayatPendaki::class.java)
